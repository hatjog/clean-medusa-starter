...
export function resolveLifecycleStatus(seller: SellerRecord): LifecycleStatus {
  ...
  // noqa: mercur15-drift — legacy Mercur 1.5 store_status normalization bridge: converts
  // uppercase Mercur 1.5 DB values ("ACTIVE", "INACTIVE") to Mercur 2 SellerStatus lowercase.
  ...
  if (rawStoreStatus === "ACTIVE") { // noqa: mercur15-drift — Mercur 1.5 bridge (see above)
    return "open"
  }
